...
``` bash?linenums
mount -o rw -t nfs -o vers=3 192.168.3.5://volume2/Workbench-Z1Z7AQCM-4T/Workbench  ~/Workbench-NAS  
mount -o rw -t nfs -o vers=3 192.168.3.5://volume3/Data-ZDH1BLYG-4T   ~/Workbench-NAS/Data  
mount -o rw -t nfs -o vers=3 192.168.3.5://volume4/Multimedia-ZDH1BMJ0-4T  ~/Workbench-NAS/Multimedia  
mount -o rw -t nfs -o vers=3 192.168.3.5://volume1/Backup-ZA17H844-8T   ~/Workbench-NAS/Backup  
mount -t davfs https://dav.jianguoyun.com/dav/Workbench  ~/Workbench-NAS/IO/webdav/jianguoyun/  
```
